<template>
  <div class="content">
    <div class="left">
      ...
      <div class="post-type">
        <input v-model="selectCommunity.name" class="post-type-value" placeholder="选择一个频道" type="text"
               @click="showCommunity()"/>
        <ul v-show="showCommunityList" class="post-type-options">
          <li v-for="(community, index) in communityList"
              :key="community.id"
              class="post-type-cell"
      ...
      <div class="post-content">
        ...
        <div class="post-sub-container">
          <div class="post-sub-header">
            <textarea id v-model="title" class="post-title" cols="30" placeholder="标题" rows="10"></textarea>
